...
local function nvim_tree_on_attach(bufnr)
  ...
  vim.keymap.set("n", "<C-t>", nt_remote.tabnew_main_pane, opts("Open in treemux without tmux split"))
  vim.keymap.set("n", "<2-LeftMouse>", nt_remote.tabnew_main_pane, opts("Open in treemux without tmux split"))
